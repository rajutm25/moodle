...
final class mustache_template_finder_test extends \advanced_testcase {
     ...
     * @param string $theme
     * @param bool $ignoreoverrides
     * @param array $paths
     */
    public function test_get_template_directories_for_component(
            string $component, string $theme, bool $ignoreoverrides, array $paths): void {
        global $CFG;

        // Test a plugin.
        $dirs = mustache_template_finder::get_template_directories_for_component($component, $theme, $ignoreoverrides);
    ...
    public static function valid_template_filepath_provider(): array {
        return [
            ...
            'Template overridden by theme but absolute path syntax used' => [
    ...
    public function test_invalid_name_get_template_filepath(): void {
        $this->expectException(\coding_exception::class);
        $this->expectExceptionMessage('Templates names must be specified as "componentname/templatename"' .
                                      ' or "/componentname/templatename" ("/octopus" requested)');
